...
async def main():
    ...
    dp.include_routers(start.router, create_post.router, create_notification.router, menu.router, auto_reposter.router, get_episodes.router, add_episodes_to_db.router, add_title_to_db.router)
